...
UIS.InputBegan:Connect(function(input, gameProcessed)
	if input.KeyCode == ((typeof(ui_options.toggle_key) == "EnumItem") and ui_options.toggle_key or Enum.KeyCode.U) then
			...
			function window_data:AddTab(tab_name)
				...
				do -- Tab Elements
					...
					function tab_data:AddKeybind(keybind_name, callback, keybind_options)
						...
						keybind_options = {
							["standard"] = keybind_options.standard or Enum.KeyCode.U,
						}
...
do -- Example UI
	...
	do -- Elements
		...
		Tab:AddKeybind("Keybind", function(key)
			...
			["standard"] = Enum.KeyCode.U -- Default: RightShift
		})
...
local Window = library:AddWindow("Twinkle Ware", {
...
CreditTAB:AddButton("Twinkle is best scripter", function(bool)
